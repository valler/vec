...
test("vec", () => {
  assertEquals(vec(1, 0, 0, 0), [1, 0, 0, 0]);
});
...
test("zero", () => {
  assertEquals(zero(), [0, 0, 0, 0]);
});

test("one", () => {
  assertEquals(one(), [1, 1, 1, 1]);
});

test("e1", () => {
  assertEquals(e1(), [1, 0, 0, 0]);
});

test("e2", () => {
  assertEquals(e2(), [0, 1, 0, 0]);
});

test("e3", () => {
  assertEquals(e3(), [0, 0, 1, 0]);
});

test("e4", () => {
  assertEquals(e4(), [0, 0, 0, 1]);
});
